...
//#define USE_ST7735_80x160
//#define USE_ST7789_240x240_WOCS
//#define USE_ST7789_240x320
...
#define PIN_BACKLIGHT_CONTROL   (15)
...
#elif defined(USE_ST7735_80x160)
  ...
  #define BACKLIGHT_HIGH      192 // n/256 PWM
  #define BACKLIGHT_LOW       80 // n/256 PWM
#elif defined(USE_ST7789_240x320)
  #include <Adafruit_ST7789.h> // Hardware-specific library for ST7789
  #include "Nimbus_Sans_L_Regular_Condensed_16.h"
  #define Adafruit_LCD Adafruit_ST7789
  // Custom Font (gfxFont)
...
Adafruit_LCD tft = Adafruit_LCD(TFT_CS, TFT_DC, TFT_RST);
...
void setup(void) {
  ...
  analogWrite(PIN_BACKLIGHT_CONTROL, BACKLIGHT_HIGH); // n/256
  ...
  tft.setFont(CUSTOM_FONT, CUSTOM_FONT_OFS_Y);
  tft.setTextSize(1);
  time = millis() - time;
